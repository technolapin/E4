...
extern void EPSGraphe(graphe * g, char *filename, double r, double t, double marge, int noms_sommets, int v_sommets, int col_sommets, int v_arcs);
...
extern int Degre(graphe * g, int s);
...
extern void DepthTree(graphe * g, int a, TYP_VARC *depth, int *farthest);
extern graphe * MaxDiameterTree(graphe * g);
extern int LCA(graphe * g, int i, int j);
extern graphe * RootTree(graphe * g, graphe * g_1, int i);
extern void DistRoot(graphe * g, int r);
...
extern void Dijkstra(graphe * g, int i);
extern void Lee(graphe * g, int i);
extern void LeeNO(graphe * g, graphe * g_1, int i);
extern graphe * PCC(graphe * g, int d, int a);
extern graphe * PCCna(graphe * g, int d, int a);

#ifdef PINK
extern graphe * Image2Graphe(struct xvimage *image);
extern struct xvimage *Graphe2Image(graphe * g, int rs);
#endif
